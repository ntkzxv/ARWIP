'use client'
import { User, History, CreditCard, Users, ShieldCheck, ClipboardList } from 'lucide-react' 
    ...
    <div className="w-full lg:w-80 space-y-4">
      <div className="bg-white rounded-[30px] p-6 border border-slate-100 shadow-sm flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Credit Score</p>
            <p className="text-xl font-bold text-slate-900">{customerScore}%</p>
          </div>
        </div>
